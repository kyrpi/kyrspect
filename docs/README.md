# Kyrspect Documentation / Dokümantasyon

Welcome to the **Kyrspect & Kyrspect WebAssembly** documentation.

Lütfen tercih ettiğiniz dili seçin / Please select your preferred language:

---

## English Documentation
- [Getting Started & Auto-Wasm Detection](./en/getting-started.md)
- [DRM (optional)](./en/drm.md)
- [Startup and load time](./en/startup.md)
- [Build & Compilation Guide](./en/build-guide.md)
...
- [Başlangıç & Otomatik Wasm Tespiti](./tr/baslangic.md)
- [DRM (isteğe bağlı)](./tr/drm.md)
- [Başlangıç ve yükleme süresi](./tr/yukleme.md)
- [Derleme ve Paketleme Kılavuzu](./tr/derleme-rehberi.md)
